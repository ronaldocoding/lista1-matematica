# Primeira lista de exercícios de Matemática Básica

## Sobre 📚

Esse trabalho foi feito como forma de obtenção de nota parcial à matéria de Matemática Básica do primeiro período do curso de Sistemas de Informação da Universidade do Estado do Amazonas.
